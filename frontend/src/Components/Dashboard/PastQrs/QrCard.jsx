          ...
          <div className="flex gap-6 flex-col sm:flex-row w-full">
            ...
            <div className="flex flex-row sm:flex-col justify-between sm:justify-normal">
              ...
              <div className="flex flex-row gap-1 flex-1">
                ...
                <button type="button" className="text-white bg-red-500 h-[35px] hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded text-sm p-2.5 text-center inline-flex items-center me-2 ">
