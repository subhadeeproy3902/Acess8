...
import { faGlobe, faQrcode, faCaretUp, faTasks, faServer } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <div className="w-full md:w-1/2 xl:w-1/3 p-6 px-0 sm:p-6">
            <div className="bg-gradient-to-b from-pink-200 to-pink-100 border-b-4 border-pink-600 rounded-lg shadow-xl p-5">
              <div className="flex flex-row items-center">
                <div className="flex-shrink pr-4">
                  <div className="rounded-full p-5 bg-pink-600"><FontAwesomeIcon icon={faQrcode} size="2x" inverse /></div>
                </div>
                <div className="flex-1 text-right md:text-center">
                  <h5 className="font-bold uppercase text-gray-600">Qr Generated</h5>
                  <h3 className="font-bold text-3xl pt-2">{qrtotal} <Link to="/dashboard/past-qrs" className="text-pink-500"><FontAwesomeIcon icon={faCaretUp} /></Link></h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 xl:w-1/3 p-6 px-0 sm:p-6">
            <div className="bg-gradient-to-b from-yellow-200 to-yellow-100 border-b-4 border-yellow-600 rounded-lg shadow-xl p-5">
              <div className="flex flex-row items-center">
                <div className="flex-shrink pr-4">
                  <div className="rounded-full p-5 bg-yellow-600"><FontAwesomeIcon icon={faQrcode} size="2x" inverse /></div>
                </div>
                <div className="flex-1 text-right md:text-center">
                  <h5 className="font-bold uppercase text-gray-600">Notes Saved</h5>
                  <h3 className="font-bold text-3xl pt-2">0 <Link to="/dashboard/past-qrs" className="text-yellow-500"><FontAwesomeIcon icon={faCaretUp} /></Link></h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 xl:w-1/3 p-6 px-0 sm:p-6">
            <div className="bg-gradient-to-b from-purple-200 to-purple-100 border-b-4 border-purple-600 rounded-lg shadow-xl p-5">
              <div className="flex flex-row items-center">
                <div className="flex-shrink pr-4">
                  <div className="rounded-full p-5 bg-purple-600"><FontAwesomeIcon icon={faTasks} size="2x" inverse /></div>
                </div>
                <div className="flex-1 text-right md:text-center">
                  <h5 className="font-bold uppercase text-gray-600">TODOs</h5>
                  <h3 className="font-bold text-3xl pt-2">1 <Link to="/dashboard/past-qrs" className="text-purple-500"><FontAwesomeIcon icon={faCaretUp} /></Link></h3>
                </div>
              </div>
            </div>
          </div>
