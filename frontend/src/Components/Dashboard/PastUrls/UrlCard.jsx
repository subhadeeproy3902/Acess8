              ...
              <div className="flex w-10/12 flex-col">
                ...
                <div className="flex flex-row gap-10">
                  <div className="gap-4 sm:gap-3 flex flex-1 flex-col">
                    <a className="line-clamp-1 text-blue-700 text-xl font-semibold break-all no-underline cursor-pointer" href={url.shortUrl} rel="noopener noreferrer" target="_blank">
                      {url.shortUrl}
                    </a>
