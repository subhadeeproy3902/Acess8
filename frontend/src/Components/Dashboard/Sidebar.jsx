...
const Sidebar = () => {
  ...
  return (
    <>
            ...
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              >
                <img
                  ...
                  alt="Flowbite Logo"
                />
                <span className="self-center pt-4 text-2xl font-semibold whitespace-nowrap text-white">
                  cess8
                </span>
              </Link>
            </div>
      ...
      <aside id="logo-sidebar" className={`z-10 w-64 fixed inset-y-0 left-0 pt-[4.5rem] flex-shrink-0 lg:translate-x-0  bg-gray-900 transition-transform duration-300 ease-in-out transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'
        }`}>
        <div className="h-full overflow-hidden px-3 pb-4 pt-6 bg-gray-800">
            ...
            <li>
              ...
              {isDropdownOpen && (
                <ul id="dropdown-example" className="pt-2 space-y-1">
                  ...
                  <Link to="/dashboard/notes-saver" className={(isAeroNotesPage) ? "flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 bg-blue-700" : "flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group  text-white hover:bg-gray-700"}>AeroNotes
                  </Link>
                </ul>
              )}
            </li>
          ...
          <ul className="pt-4 mt-4 space-y-1 font-medium border-t border-gray-700">
...
function ProductLink({ to, children, ...props }) {
  ...
  return (
    <li>
      <Link
        to={to} {...props}
        className={isActive ? "flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 bg-blue-700" : "flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group  text-white hover:bg-gray-700"}
      >
        {children}
      </Link>
    </li>
...
function CustomLink({ to, children, ...props }) {
  ...
  return (
    <li>
      <Link
        to={to} {...props}
        className={isActive ? "flex items-center p-2 bg-blue-700 text-white rounded-lg group" : "flex items-center p-2  rounded-lg text-white  hover:bg-gray-700 group"}
      >
        {children}
      </Link>
    </li>
